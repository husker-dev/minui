...
class MinUIEnvironment { companion object {

    private val tempDir = File("${System.getProperty("java.io.tmpdir")}/minui_cache/${MinUI.version}")
    private const val fileLockName = "dir.lock"

    val file = getCompatibleFolder()
